...
def write_to_csv(results, klthreshold, states, case, lsh=True):
    ...
    if lsh:
        file_workbook = "../results/ctu_connection/3LSH_rh_notall_direction_timediff_{}_ctu_connection_0.01_lsh_results_{}_{}_{}.xlsx".format(
            pre, window,
            stride,
            case)
    else:
        file_workbook = "../results/ctu_connection/notall_direction_timediff_{}_ctu_connection_trigram_results_{}_{}_{}.xlsx".format(
            pre, window,
            stride,
            case)
...
def train_model(malicious_traces_file, difference):
    ...
    parser.add_argument('--binarycodebytes', '-c', help="binarycodebytes", type=str, default='1000')
