...
def write_to_csv(results, klthreshold, states, case, lsh=True):
    ...
    if lsh:
        file_workbook = "../results/ctu/ctu_0.1_lsh_results_{}_{}_{}.xlsx".format(window, stride, case)
    else:
        file_workbook = "../results/ctu/ctu_trigram_results_{}_{}_{}.xlsx".format(window, stride, case)
...
def run_single_scenario_evaluation(lsh=True):
    ...
    global data_dir
    global scenario
    rootdir = "../data/ctu_13/single_scenario"
...
def run_multiple_scenarios_evaluation(lsh=True):
    ...
    global data_dir
    global scenario
    rootdir = "../data/ctu_13/multiple_scenarios"
