...
def write_to_csv(results, klthreshold, states, case, lsh=True):
    ...
    if lsh:
        file_workbook = "../results/ctu_connection/{}_ctu_connection_0.1_lsh_results_{}_{}_{}.xlsx".format(pre, window,
                                                                                                           stride,
                                                                                                           case)
    else:
        file_workbook = "../results/ctu_connection/{}_ctu_connection_trigram_results_{}_{}_{}.xlsx".format(pre, window,
                                                                                                           stride,
                                                                                                           case)
