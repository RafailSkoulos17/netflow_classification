...
def write_to_csv(results, klthreshold, states, case, lsh=True):
    ...
    if lsh:
        file_workbook = "../results/ctu/all_IPs_3LSHs_majority_rh_{}_ctu_0.05_lsh_results_{}_{}_{}.xlsx".format(pre, window,
                                                                                         stride,
                                                                                         case)
    else:
        file_workbook = "../results/ctu/{}_ctu_trigram_results_{}_{}_{}.xlsx".format(pre, window,
                                                                                     stride,
                                                                                     case)
...
def run_single_scenario_evaluation(lsh=True):
    ...
    window = '1500'
    stride = '750'
    rootdir = '../data/discretized_data_{}_{}/ctu_13/single_scenario'.format(window, stride)
...
def run_multiple_scenarios_evaluation(lsh=True):
    ...
    window = '100median'
    stride = '50median'
    rootdir = '../data/discretized_data_{}_{}/ctu_13/multiple_scenarios'.format(window, stride)
