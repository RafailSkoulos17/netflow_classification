...
def write_to_csv(results, klthreshold, states, case, lsh=True):
    ...
    if lsh:
        file_workbook = workbook_path + "/3LSHs_RH_{}_ctu_0.05_lsh_results_{}_{}_{}.xlsx".format(pre,
                                                                                                 window,
                                                                                                 stride,
                                                                                                 case)
    else:
        file_workbook = workbook_path + "/trigram_results_{}_{}_{}_{}.xlsx".format(pre, window,
                                                                                stride,
                                                                                case)
    #
    # if lsh:
